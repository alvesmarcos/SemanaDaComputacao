    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flex: 0.5, flexDirection: 'column', justifyContent: 'flex-end', padding: 16 }}>
            <TouchableOpacity style={{ backgroundColor: colors.primary, borderColor: '#fff', borderWidth: 1,  borderRadius: 5 }}>
              <Text style={[styles.buttonText, { color: colors.white }]}>Cadastre-se</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ backgroundColor: colors.white, marginTop: 16, borderRadius: 5 }}>
